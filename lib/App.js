...
var _PopUpHeader = _interopRequireDefault(require("./components/PopUpHeader/PopUpHeader"));
require("./App.css");
var _AddressMap = _interopRequireDefault(require("./components/AddressMap/AddressMap"));
...
class App extends _react.Component {
  ...
  async getList() {
    try {
      const response = await _axios.default.get("https://travpro.yourworldapps.nl/API/app/v2/listings.php?app=1435&lat1=36.5098445064823&lat2=35.74337885497288&lon1=-114.83208606646728&lon2=-115.48191020892334?category=&query="); // Replace with your API endpoint
  ...
  render() {
    ...
    return /*#__PURE__*/_react.default.createElement("div", {
      className: "app"
    }, /*#__PURE__*/_react.default.createElement(_PopUpHeader.default, null), /*#__PURE__*/_react.default.createElement(_AddressMap.default, {
      hotels: hotels
